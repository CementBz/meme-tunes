...
export function YoutubeTab({ previewVolume, onPreviewVolumeChange, onSubmit }: YoutubeTabProps) {
    ...
    <div className="browser-tab-content">
      ...
      {!selected && (
        <p style={{ fontSize: "0.8rem" }}>
          ⚠️ Eventuelle Ausfälle: YouTube begrenzt die tägliche Anzahl an Suchen. Falls die Suche mal nichts findet,
          einfach "iTunes" oder "Deezer" daneben probieren.
        </p>
      )}
